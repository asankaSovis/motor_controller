...
## Buttons
#set_property -dict { PACKAGE_PIN D20   IOSTANDARD LVCMOS33 } [get_ports { panic_btn }]; #IO_L4N_T0_35 Sch=btn[0]
...
#set_property -dict { PACKAGE_PIN V18   IOSTANDARD LVCMOS33 } [get_ports { motor_relay }]; #IO_L21N_T3_DQS_34 Sch=ck_io[5]
