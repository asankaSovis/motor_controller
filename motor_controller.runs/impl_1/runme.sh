...
HD_PWD='/home/asanka/Documents/Vivado/motor_controller/motor_controller.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log motor_controller.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source motor_controller.tcl -notrace
